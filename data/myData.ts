export default {
  ...
  about:
    "자바스크립트를 이용한 프로젝트 설계부터 배포까지의 경험을 가지고 있으며, 사용자와의 인터렉션과 경험을 담당하는 역동적인 프론트엔드 생태계를 좋아하고 다양한 환경에 반응하도록 UI/UX 를 구현하려 노력합니다. 사용자의 입장에서 사용자 경험을 향상 시키기 위해 노력하고 단순히 제품을 만드는 개발자라기 보단 제품을 사용하는 사용자이자 제품을 만드는 구성원으로써 동료들과 커뮤니케이션하며 제품을 발전시키려 노력합니다.",
  phone: "010-9943-3734",
  companies: [
    {
      name: "알서포트",
      ...
      pjojects: [
        {
          ...
          tasks: [
            ...
            "URL Scheme 를 이용해 원격제어(웹뷰어) 실행전 ip/mac address 체크 기능을 개발하였습니다.",
          ],
        },
        {
          name: "Web Viewer",
        ...
        },
        {
          ...
          tasks: [
            "코로나 이후 점점 많아지는 고객 문의를 대응 하기 위해 리모트 뷰 챗봇을 프로젝트에 참여하게되었습니다. 챗봇을 통해 유선문의를 약 20% 줄일 수 있었습니다.",
