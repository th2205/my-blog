      ...
      projects: [
        {
          ...
          tasks: [
            ...
            "데이터에 의한 뷰 컨트롤을 위해 Observer Pattern 을 이용한 라이브러리를 만들어 일부 페이지에 적용했습니다. 이를 통해 기존 명령형 프로그래밍 방식에서 선언형 프로그래밍으로의 개발이 가능해졌습니다.",
        ...
        },
        {
          ...
          tasks: [
            ...
            "WebSocket, MediaSource API를 이용해 실시간 영상 스트리밍을 구현하였습니다.",
