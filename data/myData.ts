      ...
      pjojects: [
        ...
        },
        {
          ...
          tasks: [
            ...
            "컴포넌트는 bem 설계 방법론에 따라 스타일을 작업했습니다. bem 설계를 적용 후 클래스명을 보다 직관적으로 작성 할 수 있었고 수정과 기능 추가를 쉽게 할 수 있었습니다.",
          ],
        },
        {
        ...
        },
        {
          ...
          tasks: [
            ...
            "webpack 을 이용한 개발 환경 설정부터 서버 배포까지 모든 개발 과정을 경험했습니다.",
          ],
        },
        {
          name: "RV box",
          description:
            "응용프로그램의 역할을 대신해주는 하드웨어 RVBox 의 설정, 관리 웹앱",
